      ...
      <div className="bg-club-blue text-white py-12 md:py-16 flex-grow">
        <div className="container mx-auto px-4">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-white/20">
                  <th className="py-4 px-4 text-left text-club-yellow font-raleway">Categoría</th>
                  <th className="py-4 px-4 text-left text-club-yellow font-raleway">Cuota</th>
                  <th className="py-4 px-4 text-left text-club-yellow font-raleway">Condición</th>
                </tr>
              </thead>
              <tbody>
                {categoriasSocios.map((categoria, index) => (
                  <tr
                    key={index}
                    className={`border-b border-white/10 ${index % 2 === 0 ? "bg-club-blue/80" : "bg-club-blue"}`}
                  >
                    <td className="py-4 px-4 font-medium font-raleway">{categoria.categoria}</td>
                    <td className="py-4 px-4 font-roboto">${categoria.valor.toLocaleString("es-AR")}</td>
                    <td className="py-4 px-4 text-white/80 font-roboto">{categoria.condicion}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-12 bg-club-blue/50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-club-yellow mb-4 font-raleway">Información importante</h3>
            <ul className="space-y-2 text-white/90 font-roboto">
              <li className="flex items-start">
                <span className="text-club-yellow mr-2">•</span>
                <span>Las cuotas se abonan del 1 al 10 de cada mes.</span>
              </li>
              <li className="flex items-start">
                <span className="text-club-yellow mr-2">•</span>
                <span>
                  Para mantener la condición de socio activo, es necesario estar al día con el pago de la cuota social.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-club-yellow mr-2">•</span>
